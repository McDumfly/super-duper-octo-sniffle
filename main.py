...
for i in kerdesek:
    ...
    valasz_szam = input("\nVálassz egy számot (1, 2 vagy 3): ").strip()

    while not valasz_szam.isnumeric():
        print("Hiba: csak számot tudsz beírni.")
        valasz_szam = input("\nVálassz egy számot (1, 2 vagy 3): ").strip()

    while int(valasz_szam) not in [1, 2, 3]:
        print("Hiba: csak 1, 2 vagy 3 válaszok közül választhatsz.")
        valasz_szam = input("\nVálassz egy számot (1, 2 vagy 3): ").strip()

    valasz_szam = int(valasz_szam)
